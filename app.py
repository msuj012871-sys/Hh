...
@app.route('/')
def home():
    return f"<h1>DroX Hosting Test Server</h1><p>Running at {time.ctime()}</p>"
...
def login():
    ...
    <head>
        ...
        <title>DroX Hosting | Login</title>
        <style>
    ...
    <body>
        ...
        <div class="login-container">
            <div class="logo">DroX Hosting</div>
...
if __name__ == "__main__":
    ...
    print(f"""
    ╔══════════════════════════════════════════╗
    ║      DroX Hosting - Unlimited Servers    ║
